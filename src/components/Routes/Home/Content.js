...
export const content = {
  hero: {
    title: '<i>Buzzier</i> transforms any screen into a <i>digital billboard.</i>',
    description:
  ...
  eventLive: {
    left: {
      title: 'Buzzier is <i>live!</i>',
      subtitle: '<u>16 Weeks</u>  |  <u>6 Days</u>  |  <u>14 Hours</u>',
    },
    right: {
    ...
    cols: [
      ...
      },
      {
        id: 2,
        title: '100%',
        description: 'Devices connected seamlessly with our ad service.',
        link: {
          type: 2,
          target: '_blank',
          to: 'https://buzz.fit',
          label: 'Learn more about our healthcare industry devices at <u>Buzz Fit</u>',
        },
      },
      {
        id: 3,
        title: '$$$',
        description: 'Advertising revenue generated by all devices from the moment of installation',
        link: {
          type: 2,
          target: '_blank',
      ...
      },
      {
        id: 4,
        title: '99.9%',
        description: 'Uptime on all devices  with no intervention from our team',
        link: {
          type: 2,
          to: 'mailto:ian@buzzier.com',
          label: 'Email us for <u>more info</u>',
        },
      },
    ],
  },
  ...
  uploads: {
    ...
    uploads: [
      { id: 1, href: '/uploads/The_Industry.pdf', title: 'Ad Industry Fact Sheet', icon: 'download' },
      { id: 2, href: '/uploads/Business_Model.pdf', title: 'Business Model Fact Sheet', icon: 'download' },
      { id: 3, href: '/uploads/Technology.pdf', title: 'Technology Fact Sheet', icon: 'download' },
    ],
  },
  countdown: {
    title: 'Countdown to <i>live event</i>',
    deadline: 'February 15 2022 05:30:00 GMT-0500',
    helper: '30 units of equity available at $25,000',
  },
  eventBanner: {
    description:
      'We are hosting a LIVE event for potential investors on the 15th of February at 5:30 pm. You can meet the team and we will provide a summary of the business, a demonstration of the technology and have an open Q&A session. Attendance can be in-person* or online,  but will be by invitation only.',
